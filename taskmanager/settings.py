...
if not DEBUG:
    ...
    # Railway / reverse-proxy deployments often require CSRF trusted origins to allow POSTs.
    # Allow explicit configuration, with a safe default for Railway subdomains.
